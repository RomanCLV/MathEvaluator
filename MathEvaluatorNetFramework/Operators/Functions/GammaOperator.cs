...
{
    internal class GammaOperator : FunctionOperator
    {
        private readonly static string _fullname = "gamma";
        private readonly static string _acronym = "gamma";
        private readonly static string _description = "Returns the Gamma value of the given evaluable.";
        ...
        public GammaOperator(IEvaluable evaluable) : base(evaluable)
        {
        }

        public new static GammaOperator Create(string[] args)
        {
            ...
            return new GammaOperator(new Expression().Set(args[0]));
        }
        ...
        {
            return Funcs.Gamma(_left.Evaluate(variables));
        }

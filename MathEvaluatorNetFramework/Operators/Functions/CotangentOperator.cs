...
namespace MathEvaluatorNetFramework.Operators.Functions
{
    internal class CotangentOperator : FunctionOperator
    {
        ...
        public new static CotangentOperator Create(string[] args)
        {
            ...
            return new CotangentOperator(new Expression().Set(args[0]));
        }

        /// <summary>
        /// Evaluate the cotangent (defined as <c>cot(x) = 1 / tan(x)</c>) of the given evaluable. Set <see cref="MathEvaluator.Parameters.AngleAreInDegrees"/> to know how to process the operation.
        /// </summary>

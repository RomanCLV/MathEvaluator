...
namespace MathEvaluatorNetFramework.Operators.Functions
{
    internal class CosecantOperator : FunctionOperator
    {
        ...
        /// <summary>
        /// Evaluate the cosecant (defined as <c>csc(x) = 1 / sin(x)</c>) of the given evaluable. Set <see cref="MathEvaluator.AngleAreInDegrees"/> to know how to process the operation.
        /// </summary>

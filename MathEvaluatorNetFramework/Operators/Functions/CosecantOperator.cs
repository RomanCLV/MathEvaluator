...
namespace MathEvaluatorNetFramework.Operators.Functions
{
    ...
    {
        private readonly static string _fullname = "cosecant";
        private readonly static string _acronym = "csc";
        private readonly static string _description = "Returns the cosecant (defined as csc(x) = 1 / sin(x)) of the given evaluable.";
        ...
        public new static CosecantOperator Create(string[] args)
        {
            ...
            return new CosecantOperator(new Expression().Set(args[0]));
        }

        /// <summary>
        /// Evaluate the cosecant (defined as <c>csc(x) = 1 / sin(x)</c>) of the given evaluable. Set <see cref="MathEvaluator.Parameters.AngleAreInDegrees"/> to know how to process the operation.
        /// </summary>
        /// <param name="variables">The used variables in the evaluable entities.</param>
        /// <returns>
        /// The cosecant of the given evaluable.<br />
        /// If the evaluable is a multiple of PI (or 180°), raises a <see cref="DomainException"/> depending on <see cref="MathEvaluator.Parameters.RaiseDomainException"/>, or returns <see cref="double.NaN"/>.
        /// </returns>
